...
library(emmeans)
library(ragg)
library(SummarizedExperiment) # install via BioManager
library(ComplexHeatmap) # install via BioManager
library(gt)
library(nlme)
library(openxlsx)
library(factoextra)
...
source(here::here(quarto_path, "R", "transforms.r"), local = knitr::knit_global())
source(here::here(quarto_path, "R", "plot.r"), local = knitr::knit_global())
source(here::here(quarto_path, "R", "output.r"), local = knitr::knit_global())
source(here::here(quarto_path, "R", "input.r"), local = knitr::knit_global())
...
if (!isTRUE(getOption('knitr.in.progress'))) {
  params <- load_params(here::here(quarto_path, "resources", "Heatmap"), extra=TRUE)
} else {
